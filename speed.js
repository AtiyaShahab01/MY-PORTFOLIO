// Speed case study page: scroll-triggered fade + slide-up entrance
// for the hero and each section, same pattern as the main portfolio.

const caseBlocks = document.querySelectorAll('.case-hero, .case-section, .case-cta');
